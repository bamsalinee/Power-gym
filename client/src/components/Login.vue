<template>
  <div>
    <div class="limiter">
      <div class="container-login100" style="background-image:url('../components/images/bg-01.jpg');">
        <div class="wrap-login100">
          <form class="login100-form validate-form" v-on:submit.prevent="onLogin">
            <span class="login100-form-logo">
              <i class="fas fa-user-lock" style="color:#7D3C98 "></i>
            </span><br>
